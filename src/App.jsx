...
import PrivacyKidneyOS from "./pages/PrivacyKidneyOS";
        ...
        <section className="mx-auto grid max-w-7xl gap-12 px-6 py-24 lg:grid-cols-[1.2fr_0.8fr] lg:px-8 lg:py-32">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-300">
              Btown Labs designs and builds custom software, product experiences,
              and intelligent workflows for businesses that want technology to
              create leverage.
            </p>
        ...
        <section id="services" className="mx-auto max-w-7xl px-6 py-12 lg:px-8 lg:py-20">
          <div className="mb-10 max-w-2xl">
            ...
            <h2 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl">
              Built for clarity, speed, and impact.
            </h2>
            <p className="mt-4 text-zinc-400">
              Whether you need a product from scratch, a smarter internal system,
              or help turning technical ideas into working software, Btown Labs
              focuses on high-value execution.
            </p>
          </div>
        ...
        <section id="process" className="mx-auto max-w-7xl px-6 py-12 lg:px-8 lg:py-20">
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            {process.map((item) => (
              <div
                key={item.step}
                className="rounded-[1.75rem] border border-white/10 bg-gradient-to-b from-white/8 to-white/[0.03] p-6"
              >
                <div className="text-sm tracking-[0.35em] text-zinc-500">
                  {item.step}
                </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
            ...
            <div className="rounded-[2rem] border border-white/10 bg-zinc-900/80 p-8">
              <p className="text-lg leading-8 text-zinc-300">
                Btown Labs is a modern software development company focused on
                solving real business problems with thoughtful engineering,
                practical strategy, and strong product instincts.
              </p>
              <p className="mt-5 leading-8 text-zinc-400">
                The brand is built around sharp thinking, clean execution, and
                solutions that create leverage. The goal is simple: build
                technology that helps clients move faster, operate better, and
                look more polished while doing it.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="contact" className="mx-auto max-w-7xl px-6 pb-24 pt-12 lg:px-8 lg:pb-32">
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8 lg:p-12">
            <div className="max-w-3xl">
              ...
              <h2 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl">
                Have an idea, product, or system that needs to get built?
              </h2>
              <p className="mt-4 text-zinc-400 leading-8">
                Let’s talk about what you’re building and where Btown Labs can
                help. Replace this section with your email address, scheduling
                link, or intake form when you’re ready.
              </p>
              <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                <a
                  href="mailto:hello@btownlabs.com"
                  className="rounded-2xl bg-cyan-300 px-6 py-3 text-center text-sm font-medium text-zinc-950"
                >
                  hello@btownlabs.com
                </a>
                <a
                  href="https://btownlabs.com"
                  className="rounded-2xl border border-white/10 px-6 py-3 text-center text-sm font-medium text-white"
                >
                  btownlabs.com
                </a>
              </div>
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/privacy-policy" element={<PrivacyIndex />} />
      <Route path="/privacy/pillledger" element={<PrivacyPillLedger />} />
      <Route path="/privacy/food-ledger-kidney" element={<PrivacyFoodLedgerKidney />} />
      <Route path="/privacy/mygrocery-ezscan" element={<PrivacyMyGrocery />} />
      <Route path="/privacy/what-i-liked" element={<PrivacyWhatILiked />} />
      <Route path="/privacy/kidneyos" element={<PrivacyKidneyOS />} />
    </Routes>
  );
}